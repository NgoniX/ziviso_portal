...
class Countries
{
    ...
    {
        if(!is_null($this->getCountryFromCode($code))){
            return $this->getCountryFromCode($code)['name'];
        }
        return null;
    }

    public function getCountryFromCodeNumber($code)
    {
        if(!is_null($this->getCountryFromCode($code))){
            return $this->getCountryFromCode($code)['code'];
        }
        return null;
    }
